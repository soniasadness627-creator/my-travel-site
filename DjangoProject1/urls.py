...
from constructor.admin_emails import mass_email_admin  # ← НОВИЙ РЯДОК ДЛЯ РОЗСИЛКИ
...
urlpatterns = [
    ...
    path('admin/mass-email/', mass_email_admin.urls, name='mass_email_admin'),  # ← НОВИЙ РЯДОК
    ...
    # ========== НОВІ МАРШРУТИ ДЛЯ ОНОВЛЕНОЇ СТОРІНКИ ПОШУКУ ==========
